/*
 * fs_guard.c — VATN Native File-System Guard (C implementation)
 *
...
/*
 * vatn_fs_guard — primary entry point.
 * Evaluate a file-system operation and return a guard verdict.
 */
GuardResult vatn_fs_guard(const GuardRequest *req) {
    /* 1. Null-safety */
...
/*
 * vatn_fs_guard_version — capability negotiation at plugin startup.
 */
const char *vatn_fs_guard_version(void) {
