#!/usr/bin/env python3
"""
frejay_analysis_tool.py

Frejay FFI Demo — Python stdio bridge tool
Called by Frejay via ProcessBuilder (JSON in → JSON out on stdout).
...
The Frejay plugin (FrejayPythonAnalysisTool.java) launches this script,
