// fs_guard.odin
// Frejay Native File-System Guard — Odin implementation
//
...
// frejay_fs_guard evaluates a file-system operation and returns a verdict.
// Java calls this via MethodHandle obtained from Linker.downcallHandle().
@(export, link_name="frejay_fs_guard")
frejay_fs_guard :: proc "c" (req: ^GuardRequest) -> GuardResult {
...
// frejay_fs_guard_version returns the guard implementation version string.
// Used by FsGuardBridge for capability negotiation at startup.
@(export, link_name="frejay_fs_guard_version")
frejay_fs_guard_version :: proc "c" () -> cstring {
